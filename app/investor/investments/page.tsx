      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg hover:shadow-chart-3/5 transition-all">
            ...
            <p className="text-3xl font-bold text-chart-3">{confirmedCount}</p>
          </div>
          <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg hover:shadow-chart-2/5 transition-all">
            ...
            <p className="text-3xl font-bold text-chart-2">${totalAmount.toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <Link href="/investor/businesses" className="text-primary hover:text-primary/80 font-medium">
