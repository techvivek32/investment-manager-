...
"[project]/lib/models/Message.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/mongoose.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Message$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/models/Message.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        if (!user) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unauthorizedResponse"])();
        const { searchParams } = new URL(request.url);
        const businessId = searchParams.get("businessId");
        if (!businessId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing businessId", 400);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Message$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Message"].find({
            businessId
        }).sort({
            createdAt: 1
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(messages);
    } catch (error) {
        console.error("Get messages error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch messages", 500);
    }
}
async function POST(request) {
    try {
        ...
        if (!businessId || !text) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing fields", 400);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        // ensure either owner or investor assigned
        const vis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].findOne({
            businessId
        });
        if (!vis) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("No visibility", 403);
        let to = receiverId;
        if (!to && user.role === "investor") {
            // send to owner
            to = vis.investorId.toString() === user.id ? (await (await __turbopack_context__.A("[project]/lib/models/Business.ts [app-route] (ecmascript, async loader)")).Business.findById(businessId))?.ownerId?.toString() : undefined;
        }
        if (!to) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing receiverId", 400);
        const message = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Message$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Message"].create({
            businessId,
            senderId: user.id,
            receiverId: to,
            body: text
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(message, 201);
    } catch (error) {
        console.error("Post message error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to send message", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__9fa86128._.js.map