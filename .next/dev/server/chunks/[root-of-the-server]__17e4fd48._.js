...
async function GET(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].find().select("-passwordHash").sort({
            createdAt: -1
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(users);
    } catch (error) {
        console.error("Get users error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch users", 500);
    }
}
async function POST(request) {
    try {
        ...
        if (user.role !== "admin") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only admins can create users", 403);
        }
        ...
        if (![
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid role", 400);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const newUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUser"])(name, email, password, role);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(newUser, 201);
    } catch (error) {
        console.error("Create user error:", error);
        const message = error instanceof Error ? error.message : "Failed to create user";
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(message, 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__17e4fd48._.js.map