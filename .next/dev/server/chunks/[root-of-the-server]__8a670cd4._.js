...
"[project]/app/api/investor/businesses/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (user.role !== "investor") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only investors can access this endpoint", 403);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        ...
        const visibilityRecords = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].find({
            investorId: user.id
        });
        ...
        if ("TURBOPACK compile-time truthy", 1) query.status = status;
        ...
        const businesses = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Business"].find(query).populate("ownerId", "name email").sort({
            createdAt: -1
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(businesses);
    } catch (error) {
        console.error("Get investor businesses error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch businesses", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8a670cd4._.js.map