...
async function POST(request) {
    try {
        ...
        if (user.role !== "business_owner") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only business owners can create businesses", 403);
        }
        const body = await request.json();
        const { name, description, category, latitude, longitude, minInvestmentAmount, maxInvestmentAmount, expectedReturnPercentage } = body;
        // Validation
        ...
        if (!minInvestmentAmount || !maxInvestmentAmount || minInvestmentAmount > maxInvestmentAmount) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid investment amounts", 400);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const business = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Business"].create({
            ownerId: user.id,
            name,
            description,
            category,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(business, 201);
    } catch (error) {
        console.error("Create business error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to create business", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__88897dbc._.js.map