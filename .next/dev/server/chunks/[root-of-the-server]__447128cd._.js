...
"[project]/app/api/admin/businesses/[id]/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        if (user.role !== "admin") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only admins can update business status", 403);
        }
        ...
        if (![
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid status", 400);
        }
        const { id } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const business = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Business"].findByIdAndUpdate(id, {
            status
        }, {
            new: true
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to update business status", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__447128cd._.js.map