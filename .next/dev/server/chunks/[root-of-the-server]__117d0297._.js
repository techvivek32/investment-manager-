...
"[project]/app/api/businesses/[id]/documents/[docId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    try {
        ...
        const document = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Document$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DocumentModel"].findById(docId);
        if (!document || document.businessId.toString() !== id) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notFoundResponse"])();
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Document$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DocumentModel"].findByIdAndDelete(docId);
        business.documents = business.documents.filter((d)=>d.toString() !== docId);
        await business.save();
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to delete document", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__117d0297._.js.map