...
"[project]/app/api/admin/visibility/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const visibility = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].find().populate("investorId", "name email").populate("businessId", "name status");
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(visibility);
    } catch (error) {
        console.error("Get visibility error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch visibility records", 500);
    }
}
async function POST(request) {
    try {
        ...
        if (user.role !== "admin") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only admins can assign visibility", 403);
        }
        const body = await request.json();
        const { investorId, businessId } = body;
        if (!investorId || !businessId) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing investorId or businessId", 400);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        // Verify investor exists and has investor role
        const investor = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(investorId);
        if (!investor || investor.role !== "investor") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid investor", 400);
        }
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].findOne({
            investorId,
            businessId
        });
        if (existing) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Business already assigned to this investor", 400);
        }
        const visibility = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].create({
            investorId,
            businessId
        });
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(visibility, 201);
    } catch (error) {
        console.error("Create visibility error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to assign business to investor", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__15078915._.js.map