...
"[project]/lib/models/BusinessVisibility.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const businessVisibilitySchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    investorId: {
        type: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"].Types.ObjectId,
        ref: "User",
        required: true
...
businessVisibilitySchema.index({
    investorId: 1,
    businessId: 1
}, {
    unique: true
});
const BusinessVisibility = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.BusinessVisibility || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("BusinessVisibility", businessVisibilitySchema);
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/models/Business.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/models/BusinessVisibility.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        if (user.role === "investor") {
            ...
            investments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Investment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Investment"].find({
                investorId: user.id
            }).populate("businessId", "name minInvestmentAmount maxInvestmentAmount").sort({
                createdAt: -1
            });
        } else if (user.role === "business_owner") {
            // Business owners see investments for their businesses
            const businesses = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Business"].find({
                ownerId: user.id
            });
            ...
            }).populate("businessId", "name").populate("investorId", "name email").sort({
                createdAt: -1
            });
        } else {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid role for this endpoint", 403);
        }
...
async function POST(request) {
    try {
        ...
        if (user.role !== "investor") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only investors can create investments", 403);
        }
        const body = await request.json();
        const { businessId, amount } = body;
        if (!businessId || !amount) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing businessId or amount", 400);
        }
        if (amount <= 0) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Investment amount must be greater than 0", 400);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mongoose$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        // Verify business exists and is approved
        const business = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Business$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Business"].findById(businessId);
        if (!business) {
        ...
        if (business.status !== "approved") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Business is not approved for investments", 400);
        }
        // Verify investor has visibility to this business
        const visibility = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BusinessVisibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BusinessVisibility"].findOne({
            investorId: user.id,
            businessId
        });
        if (!visibility) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("You do not have access to this business", 403);
        }
        // Validate amount is within range
        if (amount < business.minInvestmentAmount || amount > business.maxInvestmentAmount) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(`Investment amount must be between ${business.minInvestmentAmount} and ${business.maxInvestmentAmount}`, 400);
        }
        const investment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Investment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Investment"].create({
            investorId: user.id,
            businessId,
            amount,
            status: "confirmed"
        ...
        try {
            const { DocumentModel } = await __turbopack_context__.A("[project]/lib/models/Document.ts [app-route] (ecmascript, async loader)");
            const { Notification } = await __turbopack_context__.A("[project]/lib/models/Notification.ts [app-route] (ecmascript, async loader)");
            const { AuditLog } = await __turbopack_context__.A("[project]/lib/models/AuditLog.ts [app-route] (ecmascript, async loader)");
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(investment, 201);
    } catch (error) {
        console.error("Create investment error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to create investment", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__4dbceb8e._.js.map